...
HISTORY_DATA = [
    ['2018-10', 'playa', 'ad', [10, 11, 12], [13, 14, 15], 17, 16],
    ['2018-10', 'playa', 'ad', [11, 13, 14], [10, 12, 15], 15, 8],
    ['2018-10', 'playa', 'ad', [10, 12, 15], [11, 13, 14], 15, 8],
    ['2018-10', 'playa', 'ad', [10, 12, 15], [11, 13, 14], 15, 12],
    ['2018-10', 'playa', 'ad', [11, 14, 15], [10, 12, 13], 16, 8],
    ['2018-10', 'playa', 'ad', [10, 12, 13], [11, 14, 15], 16, 7],
    ['2018-11', 'playa', 'ad', [13, 14, 16], [10, 12, 15], 16, 14],
    ['2018-11', 'playa', 'ad', [11, 13, 14], [12, 15, 16], 15, 11],
    ['2018-11', 'playa', 'ad', [10, 12, 15], [11, 13, 14], 17, 8],
    ['2018-11', 'playa', 'ad', [10, 11, 12], [13, 14, 15], 15, 12],
    ['2018-11', 'playa', 'ad', [13, 14, 15], [10, 11, 12], 16, 13],
    ['2018-11', 'playa', 'ad', [10, 11, 12], [13, 14, 15], 21, 20],
    ['2018-11', 'playa', 'ad', [13, 14, 15], [10, 11, 12], 15, 2],
    ['2018-12', 'playa', 'ad', [10, 15], [11, 13], 16, 11],
    ['2018-12', 'playa', 'ad', [10, 13, 14], [11, 15, 16], 17, 12],
    ['2018-12', 'playa', 'ad', [11, 14, 15, 17], [10, 12, 13, 16], 15, 2],
    ['2018-12', 'playa', 'ad', [10, 13, 15, 16], [11, 12, 14, 17], 16, 11],
    ['2018-12', 'playa', 'ad', [10, 13, 15, 16], [11, 12, 14, 17], 16, 9],
    ['2018-12', 'playa', 'ad', [10, 12, 14], [13, 15, 16], 16, 3],
    ['2018-12', 'playa', 'ad', [10, 13, 16], [12, 14, 15], 17, 6],
    ['2019-12', 'playa', 'ad', [13, 14, 15], [10, 12, 16], 17, 7],
    ['2018-12', 'playa', 'ad', [13, 14, 15], [10, 12, 16], 18, 16],
    ['2018-12', 'playa', 'ctf', [15, 16], [10, 12], 8, 3],
    ['2018-13', 'playa', 'ad', [10, 12, 14], [11, 13, 16], 15, 5],
    ['2018-13', 'playa', 'ad', [10, 12, 14], [11, 13, 16], 15, 0],
    ['2018-13', 'playa', 'ad', [11, 14, 15], [10, 13, 16], 16, 14],
    ['2018-13', 'playa', 'ad', [10, 13, 16], [11, 14, 15], 17, 16],
    ['2018-13', 'playa', 'ad', [10, 13, 16], [12, 14, 15], 15, 5],
    ['2018-13', 'playa', 'ad', [13, 14, 15], [10, 12, 16], 15, 4],
    ['2018-13', 'playa', 'ad', [10, 11, 12], [13, 14, 15], 17, 15],
...
class TestFunes(unittest.TestCase):
  ...
  @patch('builtins.open', mock_open(read_data='[["1","c",[2,3],[4,5],6,7]]'))
  def test_loads_history_legacy(self):
    fun = funes.funes()
    self.assertEqual([['1', '', 'c', [2, 3], [4, 5], 6, 7]], fun.get_history())
  ...
  def test_funes(self):
    ...
    minqlx_fake.call_command('!funes')
    self.assertInMessages('This week: no history with these players.')
